...
|                | Name           |
| -------------- | -------------- |
| | **[Gaussian](/documentation/code/classes/classgambit_1_1priors_1_1gaussian/)**(const std::vector< std::string > & param, const [Options](/documentation/code/classes/classgambit_1_1options/) & options) |
| virtual void | **[transform](/documentation/code/classes/classgambit_1_1priors_1_1gaussian/)**(const std::vector< double > & unitpars, std::unordered_map< std::string, double > & outputMap) const override<br>Transformation from unit interval to the [Gaussian](/documentation/code/classes/classgambit_1_1priors_1_1gaussian/).  |
| virtual std::vector< double > | **[inverse_transform](/documentation/code/classes/classgambit_1_1priors_1_1gaussian/)**(const std::unordered_map< std::string, double > & ) const override<br>Transform from parameter back to unit hypercube.  |
| virtual double | **[operator()](/documentation/code/classes/classgambit_1_1priors_1_1gaussian/)**(const std::vector< double > & ) const override<br>Log of PDF density.  |
