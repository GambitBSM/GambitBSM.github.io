...
|                | Name           |
| -------------- | -------------- |
| | **[FunkInterp](/documentation/code/classes/classdafunk_1_1funkinterp/#function-dafunkfunkinterp-funkinterp)**(Funk f, std::vector< double > & Xgrid, std::vector< double > & Ygrid, std::string mode ="lin") |
| | **[FunkInterp](/documentation/code/classes/classdafunk_1_1funkinterp/#function-dafunkfunkinterp-funkinterp)**(std::string arg, std::vector< double > & Xgrid, std::vector< double > & Ygrid, std::string mode ="lin") |
| | **[FunkInterp](/documentation/code/classes/classdafunk_1_1funkinterp/#function-dafunkfunkinterp-funkinterp)**(double x, std::vector< double > & Xgrid, std::vector< double > & Ygrid, std::string mode ="lin") |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkinterp/#function-dafunkfunkinterp-value)**(const std::vector< double > & data, size_t bindID) |
