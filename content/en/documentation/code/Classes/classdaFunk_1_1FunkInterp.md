...
|                | Name           |
| -------------- | -------------- |
| | **[FunkInterp](/documentation/code/classes/classdafunk_1_1funkinterp/#function-funkinterp)**(Funk f, std::vector< double > & Xgrid, std::vector< double > & Ygrid, std::string mode ="lin") |
| | **[FunkInterp](/documentation/code/classes/classdafunk_1_1funkinterp/#function-funkinterp)**(std::string arg, std::vector< double > & Xgrid, std::vector< double > & Ygrid, std::string mode ="lin") |
| | **[FunkInterp](/documentation/code/classes/classdafunk_1_1funkinterp/#function-funkinterp)**(double x, std::vector< double > & Xgrid, std::vector< double > & Ygrid, std::string mode ="lin") |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkinterp/#function-value)**(const std::vector< double > & data, size_t bindID) |
