...
|                | Name           |
| -------------- | -------------- |
| | **[Bottle](/documentation/code/classes/classdafunk_1_1bottle/)**(Funk f, std::string msg) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1bottle/)**(const std::vector< double > & data, size_t bindID) |
