...
|                | Name           |
| -------------- | -------------- |
| | **[Bottle](/documentation/code/classes/classdafunk_1_1bottle/#function-dafunkbottle-bottle)**(Funk f, std::string msg) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1bottle/#function-dafunkbottle-value)**(const std::vector< double > & data, size_t bindID) |
