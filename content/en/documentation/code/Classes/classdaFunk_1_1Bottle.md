...
|                | Name           |
| -------------- | -------------- |
| | **[Bottle](/documentation/code/classes/classdafunk_1_1bottle/#function-bottle)**(Funk f, std::string msg) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1bottle/#function-value)**(const std::vector< double > & data, size_t bindID) |
