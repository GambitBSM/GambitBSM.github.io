...
# class Gambit::ColliderBit::Analysis_CMS_13TeV_MultiLEP_2SSLep_36invfb
...
|                | Name           |
| -------------- | -------------- |
| | **[Analysis_CMS_13TeV_MultiLEP_2SSLep_36invfb](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__2sslep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-2sslep-36invfb-analysis-cms-13tev-multilep-2sslep-36invfb)**() |
| virtual void | **[collect_results](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__2sslep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-2sslep-36invfb-collect-results)**()<br>Gather together the info for likelihood calculation.  |
...
|                | Name           |
| -------------- | -------------- |
| | **[Analysis_CMS_13TeV_MultiLEP_36invfb](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-analysis-cms-13tev-multilep-36invfb)**() |
| virtual void | **[run](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-run)**(const HEPUtils::Event * event) |
...
| vector< double > | **[get_mll_mT](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-get-mll-mt)**(vector< vector< const HEPUtils::Particle * > > pair_cont, vector< const HEPUtils::Particle * > leptons, HEPUtils::P4 met, int type) |
| double | **[get_mTmin](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-get-mtmin)**(vector< const HEPUtils::Particle * > leptons, HEPUtils::P4 met) |
...
|                | Name           |
| -------------- | -------------- |
| virtual void | **[analysis_specific_reset](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-analysis-specific-reset)**()<br>Reset the analysis-specific variables.  |
...
|                | Name           |
| -------------- | -------------- |
| std::map< string, [EventCounter](/documentation/code/classes/classgambit_1_1colliderbit_1_1eventcounter/) > | **[_counters](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#variable-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-counters)**  |
...
**Reimplements**: [Gambit::ColliderBit::Analysis_CMS_13TeV_MultiLEP_36invfb::collect_results](/documentation/code/classes/classgambit_1_1colliderbit_1_1analysis__cms__13tev__multilep__36invfb/#function-gambitcolliderbitanalysis-cms-13tev-multilep-36invfb-collect-results)
