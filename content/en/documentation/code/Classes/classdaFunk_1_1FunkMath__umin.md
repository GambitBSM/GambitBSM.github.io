...
|                | Name           |
| -------------- | -------------- |
| | **[FunkMath_umin](/documentation/code/classes/classdafunk_1_1funkmath__umin/)**(Funk f) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkmath__umin/)**(const std::vector< double > & data, size_t bindID) |
