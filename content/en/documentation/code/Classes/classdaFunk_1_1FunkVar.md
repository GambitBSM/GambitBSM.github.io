...
|                | Name           |
| -------------- | -------------- |
| | **[FunkVar](/documentation/code/classes/classdafunk_1_1funkvar/#function-dafunkfunkvar-funkvar)**(std::string arg) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkvar/#function-dafunkfunkvar-value)**(const std::vector< double > & data, size_t bindID) |
