...
|                | Name           |
| -------------- | -------------- |
| | **[FunkVar](/documentation/code/classes/classdafunk_1_1funkvar/#function-funkvar)**(std::string arg) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkvar/#function-value)**(const std::vector< double > & data, size_t bindID) |
