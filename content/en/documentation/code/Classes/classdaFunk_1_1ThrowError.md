...
|                | Name           |
| -------------- | -------------- |
| | **[ThrowError](/documentation/code/classes/classdafunk_1_1throwerror/#function-throwerror)**(std::string msg) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1throwerror/#function-value)**(const std::vector< double > & data, size_t bindID) |
