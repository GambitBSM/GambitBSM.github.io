---
title: "class Gambit::Models::DMsimpVectorMedMajoranaDMSimpleSpec"

description: "[No description available]"

---

# class Gambit::Models::DMsimpVectorMedMajoranaDMSimpleSpec



[No description available]

Inherits from [Gambit::SLHASimpleSpec< DMsimpVectorMedMajoranaDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/), [Gambit::Spec< Derived >](/documentation/code/classes/classgambit_1_1spec/), [Gambit::SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[DMsimpVectorMedMajoranaDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#function-dmsimpvectormedmajoranadmsimplespec)**(const SLHAea::Coll & input) |
| | **[DMsimpVectorMedMajoranaDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#function-dmsimpvectormedmajoranadmsimplespec)**(const [DMsimpVectorMedMajoranaDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/) & other)<br>Copy constructor.  |
| virtual | **[~DMsimpVectorMedMajoranaDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#function-dmsimpvectormedmajoranadmsimplespec)**()<br>Destructor.  |
| virtual void | **[add_to_SLHAea](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#function-add-to-slhaea)**(int , SLHAea::Coll & slha) const<br>Add SLHAea object using the SimpleSpec_to_SLHAea routine.  |
| int | **[index_offset](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#function-index-offset)**() |
| [GetterMaps](/documentation/code/classes/classgambit_1_1spec/#typedef-gettermaps) | **[fill_getter_maps](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#function-fill-getter-maps)**()<br>Wrapper functions to parameter object.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const [SpectrumContents::DMsimpVectorMedMajoranaDM](/documentation/code/classes/structgambit_1_1spectrumcontents_1_1dmsimpvectormedmajoranadm/) | **[contents](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedmajoranadmsimplespec/#variable-contents)** <br>Construct the [SubSpectrumContents](/documentation/code/classes/classgambit_1_1subspectrumcontents/).  |

## Additional inherited members

**Public Types inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedMajoranaDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Public Functions inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedMajoranaDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Protected Attributes inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedMajoranaDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
### function DMsimpVectorMedMajoranaDMSimpleSpec

```
inline DMsimpVectorMedMajoranaDMSimpleSpec(
...
```
inline DMsimpVectorMedMajoranaDMSimpleSpec(
    const DMsimpVectorMedMajoranaDMSimpleSpec & other
)
```
...
```
inline virtual ~DMsimpVectorMedMajoranaDMSimpleSpec()
```
