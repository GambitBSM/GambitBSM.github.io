...
|                | Name           |
| -------------- | -------------- |
| template <typename... Args\> <br>| **[FunkConst](/documentation/code/classes/classdafunk_1_1funkconst/)**(double c, Args ... argss) |
| | **[FunkConst](/documentation/code/classes/classdafunk_1_1funkconst/)**(double c) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkconst/)**(const std::vector< double > & data, size_t bindID) |
