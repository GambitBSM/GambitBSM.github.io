---
title: "class Gambit::Models::DMsimpVectorMedScalarDMSimpleSpec"

description: "[No description available]"

---

# class Gambit::Models::DMsimpVectorMedScalarDMSimpleSpec



[No description available]

Inherits from [Gambit::SLHASimpleSpec< DMsimpVectorMedScalarDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/), [Gambit::Spec< Derived >](/documentation/code/classes/classgambit_1_1spec/), [Gambit::SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[DMsimpVectorMedScalarDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#function-dmsimpvectormedscalardmsimplespec)**(const SLHAea::Coll & input) |
| | **[DMsimpVectorMedScalarDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#function-dmsimpvectormedscalardmsimplespec)**(const [DMsimpVectorMedScalarDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/) & other)<br>Copy constructor.  |
| virtual | **[~DMsimpVectorMedScalarDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#function-dmsimpvectormedscalardmsimplespec)**()<br>Destructor.  |
| virtual void | **[add_to_SLHAea](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#function-add-to-slhaea)**(int , SLHAea::Coll & slha) const<br>Add SLHAea object using the SimpleSpec_to_SLHAea routine.  |
| int | **[index_offset](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#function-index-offset)**() |
| [GetterMaps](/documentation/code/classes/classgambit_1_1spec/#typedef-gettermaps) | **[fill_getter_maps](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#function-fill-getter-maps)**()<br>Wrapper functions to parameter object.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const [SpectrumContents::DMsimpVectorMedScalarDM](/documentation/code/classes/structgambit_1_1spectrumcontents_1_1dmsimpvectormedscalardm/) | **[contents](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedscalardmsimplespec/#variable-contents)** <br>Construct the [SubSpectrumContents](/documentation/code/classes/classgambit_1_1subspectrumcontents/).  |

## Additional inherited members

**Public Types inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedScalarDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Public Functions inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedScalarDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Protected Attributes inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedScalarDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
### function DMsimpVectorMedScalarDMSimpleSpec

```
inline DMsimpVectorMedScalarDMSimpleSpec(
...
```
inline DMsimpVectorMedScalarDMSimpleSpec(
    const DMsimpVectorMedScalarDMSimpleSpec & other
)
```
...
```
inline virtual ~DMsimpVectorMedScalarDMSimpleSpec()
```
