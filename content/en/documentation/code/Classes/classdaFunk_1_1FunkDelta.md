...
|                | Name           |
| -------------- | -------------- |
| | **[FunkDelta](/documentation/code/classes/classdafunk_1_1funkdelta/)**(std::string arg, double pos, double width) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkdelta/)**(const std::vector< double > & data, size_t bindID) |
