...
|                | Name           |
| -------------- | -------------- |
| template <typename... Args\> <br>| **[FunkFuncM](/documentation/code/classes/classdafunk_1_1funkfuncm/)**(O * obj, double(O::*)(funcargs...) f, Args... argss) |
| template <typename... Args\> <br>| **[FunkFuncM](/documentation/code/classes/classdafunk_1_1funkfuncm/)**(shared_ptr< O > obj, double(O::*)(funcargs...) f, Args... argss) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkfuncm/)**(const std::vector< double > & data, size_t bindID) |
| template <size_t... Args\> <br>double | **[ppp](/documentation/code/classes/classdafunk_1_1funkfuncm/)**([index_list](/documentation/code/classes/structdafunk_1_1index__list/)< Args... > , std::tuple< typename std::remove_reference< funcargs >::type... > & my_input) |
