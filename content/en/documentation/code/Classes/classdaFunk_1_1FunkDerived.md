...
|                | Name           |
| -------------- | -------------- |
| | **[FunkDerived](/documentation/code/classes/classdafunk_1_1funkderived/)**(Funk f, std::string arg, Funk g) |
| | **[FunkDerived](/documentation/code/classes/classdafunk_1_1funkderived/)**(Funk f, std::string arg, double x) |
| virtual void | **[resolve](/documentation/code/classes/classdafunk_1_1funkderived/)**(std::map< std::string, size_t > datamap, size_t & datalen, size_t bindID, std::map< std::string, size_t > & argmap) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkderived/)**(const std::vector< double > & data, size_t bindID) |
