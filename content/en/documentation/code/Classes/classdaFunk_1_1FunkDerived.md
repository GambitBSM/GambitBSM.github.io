---
title: "class daFunk::FunkDerived"
...
|                | Name           |
| -------------- | -------------- |
| | **[FunkDerived](/documentation/code/classes/classdafunk_1_1funkderived/#function-dafunkfunkderived-funkderived)**(Funk f, std::string arg, Funk g) |
| | **[FunkDerived](/documentation/code/classes/classdafunk_1_1funkderived/#function-dafunkfunkderived-funkderived)**(Funk f, std::string arg, double x) |
| virtual void | **[resolve](/documentation/code/classes/classdafunk_1_1funkderived/#function-dafunkfunkderived-resolve)**(std::map< std::string, size_t > datamap, size_t & datalen, size_t bindID, std::map< std::string, size_t > & argmap) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkderived/#function-dafunkfunkderived-value)**(const std::vector< double > & data, size_t bindID) |
