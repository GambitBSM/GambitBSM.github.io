...
|                | Name           |
| -------------- | -------------- |
| | **[FunkDerived](/documentation/code/classes/classdafunk_1_1funkderived/#function-funkderived)**(Funk f, std::string arg, Funk g) |
| | **[FunkDerived](/documentation/code/classes/classdafunk_1_1funkderived/#function-funkderived)**(Funk f, std::string arg, double x) |
| virtual void | **[resolve](/documentation/code/classes/classdafunk_1_1funkderived/#function-resolve)**(std::map< std::string, size_t > datamap, size_t & datalen, size_t bindID, std::map< std::string, size_t > & argmap) |
| virtual double | **[value](/documentation/code/classes/classdafunk_1_1funkderived/#function-value)**(const std::vector< double > & data, size_t bindID) |
