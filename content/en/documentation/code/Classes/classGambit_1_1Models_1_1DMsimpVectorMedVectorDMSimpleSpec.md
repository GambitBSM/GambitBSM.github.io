---
title: "class Gambit::Models::DMsimpVectorMedVectorDMSimpleSpec"

description: "[No description available]"

---

# class Gambit::Models::DMsimpVectorMedVectorDMSimpleSpec



[No description available]

Inherits from [Gambit::SLHASimpleSpec< DMsimpVectorMedVectorDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/), [Gambit::Spec< Derived >](/documentation/code/classes/classgambit_1_1spec/), [Gambit::SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[DMsimpVectorMedVectorDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#function-dmsimpvectormedvectordmsimplespec)**(const SLHAea::Coll & input) |
| | **[DMsimpVectorMedVectorDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#function-dmsimpvectormedvectordmsimplespec)**(const [DMsimpVectorMedVectorDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/) & other)<br>Copy constructor.  |
| virtual | **[~DMsimpVectorMedVectorDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#function-dmsimpvectormedvectordmsimplespec)**()<br>Destructor.  |
| virtual void | **[add_to_SLHAea](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#function-add-to-slhaea)**(int , SLHAea::Coll & slha) const<br>Add SLHAea object using the SimpleSpec_to_SLHAea routine.  |
| int | **[index_offset](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#function-index-offset)**() |
| [GetterMaps](/documentation/code/classes/classgambit_1_1spec/#typedef-gettermaps) | **[fill_getter_maps](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#function-fill-getter-maps)**()<br>Wrapper functions to parameter object.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const [SpectrumContents::DMsimpVectorMedVectorDM](/documentation/code/classes/structgambit_1_1spectrumcontents_1_1dmsimpvectormedvectordm/) | **[contents](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormedvectordmsimplespec/#variable-contents)** <br>Construct the [SubSpectrumContents](/documentation/code/classes/classgambit_1_1subspectrumcontents/).  |

## Additional inherited members

**Public Types inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedVectorDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Public Functions inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedVectorDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Protected Attributes inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedVectorDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
### function DMsimpVectorMedVectorDMSimpleSpec

```
inline DMsimpVectorMedVectorDMSimpleSpec(
...
```
inline DMsimpVectorMedVectorDMSimpleSpec(
    const DMsimpVectorMedVectorDMSimpleSpec & other
)
```
...
```
inline virtual ~DMsimpVectorMedVectorDMSimpleSpec()
```
