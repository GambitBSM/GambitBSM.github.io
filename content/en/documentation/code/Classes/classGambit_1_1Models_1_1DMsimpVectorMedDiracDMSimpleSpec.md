---
title: "class Gambit::Models::DMsimpVectorMedDiracDMSimpleSpec"

description: "[No description available]"

---

# class Gambit::Models::DMsimpVectorMedDiracDMSimpleSpec



[No description available]

Inherits from [Gambit::SLHASimpleSpec< DMsimpVectorMedDiracDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/), [Gambit::Spec< Derived >](/documentation/code/classes/classgambit_1_1spec/), [Gambit::SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/)

## Public Functions

|                | Name           |
| -------------- | -------------- |
| | **[DMsimpVectorMedDiracDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#function-dmsimpvectormeddiracdmsimplespec)**(const SLHAea::Coll & input) |
| | **[DMsimpVectorMedDiracDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#function-dmsimpvectormeddiracdmsimplespec)**(const [DMsimpVectorMedDiracDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/) & other)<br>Copy constructor.  |
| virtual | **[~DMsimpVectorMedDiracDMSimpleSpec](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#function-dmsimpvectormeddiracdmsimplespec)**()<br>Destructor.  |
| virtual void | **[add_to_SLHAea](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#function-add-to-slhaea)**(int , SLHAea::Coll & slha) const<br>Add SLHAea object using the SimpleSpec_to_SLHAea routine.  |
| int | **[index_offset](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#function-index-offset)**() |
| [GetterMaps](/documentation/code/classes/classgambit_1_1spec/#typedef-gettermaps) | **[fill_getter_maps](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#function-fill-getter-maps)**()<br>Wrapper functions to parameter object.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| const [SpectrumContents::DMsimpVectorMedDiracDM](/documentation/code/classes/structgambit_1_1spectrumcontents_1_1dmsimpvectormeddiracdm/) | **[contents](/documentation/code/classes/classgambit_1_1models_1_1dmsimpvectormeddiracdmsimplespec/#variable-contents)** <br>Construct the [SubSpectrumContents](/documentation/code/classes/classgambit_1_1subspectrumcontents/).  |

## Additional inherited members

**Public Types inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedDiracDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Public Functions inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedDiracDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
**Protected Attributes inherited from [Gambit::SLHASimpleSpec< DMsimpVectorMedDiracDMSimpleSpec >](/documentation/code/classes/classgambit_1_1slhasimplespec/)**
...
```
inline DMsimpVectorMedDiracDMSimpleSpec(
...
```
inline DMsimpVectorMedDiracDMSimpleSpec(
    const DMsimpVectorMedDiracDMSimpleSpec & other
)
```
...
```
inline virtual ~DMsimpVectorMedDiracDMSimpleSpec()
```
