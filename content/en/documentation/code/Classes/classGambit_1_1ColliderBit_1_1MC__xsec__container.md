...
|                | Name           |
| -------------- | -------------- |
| | **[MC_xsec_container](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**()<br>Constructor.  |
| virtual | **[~MC_xsec_container](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**() |
| void | **[reset](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**()<br>Reset this instance for reuse.  |
| void | **[log_event](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**()<br>Tell the xsec object that there has been a new event.  |
| long long | **[num_events](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**() const<br>Return the total number of events seen so far.  |
| double | **[xsec_per_event](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**() const<br>Return the cross-section per event seen (in fb).  |
| void | **[set_num_events](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**(long long n)<br>Set the total number of events seen so far.  |
| void | **[average_xsec](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**(double other_xsec, double other_xsecerr, long long other_ntot)<br>Average cross-sections and combine errors.  |
| void | **[average_xsec](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**(const [MC_xsec_container](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/) & other) |
| void | **[sum_xsecs](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**(double other_xsec, double other_xsecerr, long long other_ntot)<br>Sum cross-sections and add errors in quadrature.  |
| void | **[sum_xsecs](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**(const [MC_xsec_container](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/) & other) |
| void | **[gather_xsecs](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**()<br>Collect xsec predictions from other threads and do a weighted combination.  |
| void | **[gather_num_events](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**()<br>Collect total events seen on all threads.  |
| std::map< std::string, double > | **[get_content_as_map](/documentation/code/classes/classgambit_1_1colliderbit_1_1mc__xsec__container/)**() const<br>Get content as map <string,double> map (for easy printing).  |
