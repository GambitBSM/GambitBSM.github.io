...
|                | Name           |
| -------------- | -------------- |
| virtual double | **[hard_upper](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| virtual double | **[soft_upper](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| virtual double | **[soft_lower](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| virtual double | **[hard_lower](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| | **[QedQcdWrapper](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**()<br>[QedQcdWrapper](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/) member functions.  |
| | **[QedQcdWrapper](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**(const softsusy::QedQcd & model, const [SMInputs](/documentation/code/classes/structgambit_1_1sminputs/) & input) |
| virtual int | **[get_numbers_stable_particles](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| [GetterMaps](/documentation/code/classes/classgambit_1_1spec/) | **[fill_getter_maps](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**()<br>Map fillers.  |
| SetterMaps | **[fill_setter_maps](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() |
| virtual | **[~QedQcdWrapper](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**()<br>Destructor.  |
| Model & | **[get_Model](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() |
| Input & | **[get_Input](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() |
| const Model & | **[get_Model](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| const Input & | **[get_Input](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const |
| virtual void | **[add_to_SLHAea](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**(int , [SLHAstruct](/documentation/code/namespaces/namespacegambit/) & slha) const<br>Add QEDQCD information to an SLHAea object.  |
| virtual double | **[GetScale](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**() const<br>RunningPars interface overrides.  |
| virtual void | **[SetScale](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**(double scale)<br>Manually define the current renormalisation scale (do this at own risk!)  |
| virtual void | **[RunToScaleOverride](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**(double end_scale)<br>Run masses and couplings to end_scale.  |

## Public Attributes

|                | Name           |
| -------------- | -------------- |
| double | **[hardup](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**  |
| double | **[softup](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**  |
| double | **[softlow](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**  |
| double | **[hardlow](/documentation/code/classes/classgambit_1_1specbit_1_1qedqcdwrapper/)**  |
...
**Reimplements**: [Gambit::SubSpectrum::hard_upper](/documentation/code/classes/classgambit_1_1subspectrum/)
...
**Reimplements**: [Gambit::SubSpectrum::soft_upper](/documentation/code/classes/classgambit_1_1subspectrum/)
...
**Reimplements**: [Gambit::SubSpectrum::soft_lower](/documentation/code/classes/classgambit_1_1subspectrum/)
...
**Reimplements**: [Gambit::SubSpectrum::hard_lower](/documentation/code/classes/classgambit_1_1subspectrum/)
