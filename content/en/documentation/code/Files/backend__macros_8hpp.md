...
|                | Name           |
| -------------- | -------------- |
|  | **[BE_FUNCTION_5](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGSLIST, SYMBOLNAMES, CAPABILITY)  |
|  | **[BE_FUNCTION_6](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGSLIST, SYMBOLNAMES, CAPABILITY, MODELS)  |
|  | **[BE_FUNCTION_7](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGSLIST, SYMBOLNAMES, CAPABILITY, MODELS, REF)  |
|  | **[BE_FUNCTION](/documentation/code/files/backend__macros_8hpp/)**(...)  |
|  | **[BE_FUNCTION_I](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGLIST, SYMBOLNAMES, CAPABILITY, MODELS, REF)  |
|  | **[BE_FUNCTION_I_AUX](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGLIST, SYMBOLNAMES, CAPABILITY, MODELS)  |
|  | **[BE_FUNCTION_I_OTHER](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGLIST, SYMBOLNAMES, CAPABILITY, MODELS) <br>Backend function macro for other backends (C/C++/Fortran)  |
|  | **[BE_FUNCTION_I_MAIN](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGLIST, SYMBOLNAMES, CAPABILITY, MODELS, REF) <br>Main actual backend function macro.  |
|  | **[BE_FUNCTION_I_SUPP](/documentation/code/files/backend__macros_8hpp/)**(NAME) <br>Supplemenentary backend function macro.  |
|  | **[BE_CONV_FUNCTION_FULL](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGSLIST, CAPABILITY, MODELS, REF)  |
|  | **[BE_CONV_FUNCTION_MAIN](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, ARGSLIST, CAPABILITY, MODELS, REF)  |
|  | **[BE_CONV_FUNCTION_SUPP](/documentation/code/files/backend__macros_8hpp/)**(NAME)  |
|  | **[ARG_NAME](/documentation/code/files/backend__macros_8hpp/)**(R, DATA, INDEX, ELEM) <br>Macros to add names to an argument list.  |
|  | **[FUNCTION_ARGS_SEQ](/documentation/code/files/backend__macros_8hpp/)**(ARGLIST)  |
|  | **[FUNCTION_ARGS](/documentation/code/files/backend__macros_8hpp/)**(ARGLIST)  |
|  | **[ARG_NAME_ONLY](/documentation/code/files/backend__macros_8hpp/)**(R, DATA, INDEX, ELEM) <br>Macros to get only the names corresponding to an argument list.  |
|  | **[FUNCTION_ARG_NAMES_SEQ](/documentation/code/files/backend__macros_8hpp/)**(ARGLIST)  |
|  | **[FUNCTION_ARG_NAMES](/documentation/code/files/backend__macros_8hpp/)**(ARGLIST)  |
|  | **[MODULE](/documentation/code/files/backend__macros_8hpp/)** <br>Declare the backend initialisation module BackendIniBit.  |
|  | **[BE_INI_DEPENDENCY](/documentation/code/files/backend__macros_8hpp/)**(DEP, TYPE) <br>Dependency macro for point-level backend initialisation functions (in BackendIniBit)  |
|  | **[BE_INI_CONDITIONAL_DEPENDENCY](/documentation/code/files/backend__macros_8hpp/)**(DEP, TYPE, ...) <br>Model-conditional dependency macro for point-level backend initialisation functions (in BackendIniBit)  |
|  | **[BE_ALLOW_MODEL](/documentation/code/files/backend__macros_8hpp/)**(MODEL) <br>Macro for assigning a single allowed model to an entire backend.  |
|  | **[SET_ALLOWED_MODELS](/documentation/code/files/backend__macros_8hpp/)**(NAME, MODELS) <br>Set all the allowed models for a given backend functor.  |
|  | **[MAKE_INUSE_POINTER](/documentation/code/files/backend__macros_8hpp/)**(NAME) <br>Make the inUse pipe for a given backend functor.  |
|  | **[LOAD_LIBRARY](/documentation/code/files/backend__macros_8hpp/)** <br>Macro containing initialization code.  |
|  | **[REGISTER_BACKEND](/documentation/code/files/backend__macros_8hpp/)**(BE, VER, SAFEVER, REF) <br>Register this backend with the Core if not running in standalone mode.  |
|  | **[LOAD_ALL_FACTORIES](/documentation/code/files/backend__macros_8hpp/)** <br>Load factory functions for classes provided by this backend.  |
|  | **[LOAD_FACTORIES_FOR_TYPE](/documentation/code/files/backend__macros_8hpp/)**(r, data, elem) <br>Load all factory functions for a given type.  |
|  | **[LOAD_NTH_FACTORY_FOR_TYPE](/documentation/code/files/backend__macros_8hpp/)**(r, data, i, elem) <br>Redirector from within BOOST_PP_SEQ_FOR_EACH_I to LOAD_SINGLE_FACTORY.  |
|  | **[LOAD_SINGLE_FACTORY](/documentation/code/files/backend__macros_8hpp/)**(BARENAME, NAME, ARGS, SYMBOLNAMES, ABSTRACT, PTRNAME) <br>Load a single factory function from a backend.  |
|  | **[BE_VARIABLE_I](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, SYMBOLNAMES, CAPABILITY, MODELS, REF)  |
|  | **[BE_VARIABLE_I_AUX](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, SYMBOLNAMES, CAPABILITY, MODELS)  |
|  | **[BE_VARIABLE_I_OTHER](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, SYMBOLNAMES, CAPABILITY, MODELS) <br>Backend variable macro for regular backends (C/C++/Fortran)  |
|  | **[BE_VARIABLE_I_MAIN](/documentation/code/files/backend__macros_8hpp/)**(NAME, TYPE, SYMBOLNAMES, CAPABILITY, MODELS, REF) <br>Main actual backend variable macro.  |
|  | **[BE_VARIABLE_I_SUPP](/documentation/code/files/backend__macros_8hpp/)**(NAME) <br>Supplementary backend variable macro.  |
