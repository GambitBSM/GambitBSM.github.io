...
|  | **[LOAD_FACTORIES_FOR_TYPE](/documentation/code/files/backend__macros_8hpp/#define-backend-macros-hpp-load-factories-for-type)**(r, data, elem) <br>Load all factory functions for a given type.  |
