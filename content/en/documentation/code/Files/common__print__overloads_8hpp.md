...
|                | Name           |
| -------------- | -------------- |
|  | **[USE_COMMON_PRINT_OVERLOAD](/documentation/code/files/common__print__overloads_8hpp/)**(PRINTER, TYPE) <br>Macro to call to activate a specific common print overload.  |
