...
|                | Name           |
| -------------- | -------------- |
|  | **[export_abstract](/documentation/code/files/plugin__macros_8hpp/)**(name, ...)  |
|  | **[export_object](/documentation/code/files/plugin__macros_8hpp/)**(name, ...) <br>Makes the object "name" available to the plugin interface.  |
|  | **[plugin_main](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Declaration of the main function which will be ran by the interface.  |
|  | **[gambit_plugin](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Generic plugin declaration of the from [gambit_plugin(name, type, version)]() |
|  | **[plugin_constructor](/documentation/code/files/plugin__macros_8hpp/)** <br>Runs when the plugin is loaded.  |
|  | **[plugin_deconstructor](/documentation/code/files/plugin__macros_8hpp/)** <br>Runs when the plugin is destroyed.  |
|  | **[__PLUGIN_version](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Sets the version number.  |
|  | **[__PLUGIN_no_version](/documentation/code/files/plugin__macros_8hpp/)** <br>Set version number to 0.0.0.  |
|  | **[reqd_inifile_entries](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Tells ScannerBit that these tags are required.  |
|  | **[reqd_libraries](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Tells ScannerBit that these libraries are requested.  |
|  | **[reqd_headers](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Tells ScannerBit that these include files must exist.  |
|  | **[set_flag](/documentation/code/files/plugin__macros_8hpp/)**(...) <br>Tells ScannerBit to set a flag.  |
|  | **[cxx_flags](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[REQD_INIFILE_ENTRIES](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[REQD_LIRBARIES](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[REQD_HEADERS](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[SET_FLAG](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[CXX_FLAGS](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[_ARG_N_](/documentation/code/files/plugin__macros_8hpp/)**(_1_, _2_, _3_, _4_, ret, ...)  |
|  | **[__ARG_N__](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[__COMBINE__](/documentation/code/files/plugin__macros_8hpp/)**(a, b)  |
|  | **[_COMBINE_](/documentation/code/files/plugin__macros_8hpp/)**(a, b)  |
|  | **[_STR_](/documentation/code/files/plugin__macros_8hpp/)**(a)  |
|  | **[__STR__](/documentation/code/files/plugin__macros_8hpp/)**(a)  |
|  | **[__PLUGIN_VERSION___4](/documentation/code/files/plugin__macros_8hpp/)**(major, minor, patch, release)  |
|  | **[__PLUGIN_VERSION___3](/documentation/code/files/plugin__macros_8hpp/)**(major, minor, patch)  |
|  | **[__PLUGIN_VERSION___2](/documentation/code/files/plugin__macros_8hpp/)**(major, minor)  |
|  | **[__PLUGIN_VERSION___1](/documentation/code/files/plugin__macros_8hpp/)**(major)  |
|  | **[__PLUGIN_VERSION___0](/documentation/code/files/plugin__macros_8hpp/)**()  |
|  | **[__PLUGIN_VERSION](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[EXPORT_ABSTRACT](/documentation/code/files/plugin__macros_8hpp/)**(name, ...)  |
|  | **[EXPORT_OBJECT](/documentation/code/files/plugin__macros_8hpp/)**(name, ...)  |
|  | **[PLUGIN_CONSTRUCTOR](/documentation/code/files/plugin__macros_8hpp/)**  |
|  | **[PLUGIN_DECONSTRUCTOR](/documentation/code/files/plugin__macros_8hpp/)**  |
|  | **[__PLUGIN_MAIN_RET_VAL__](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[PLUGIN_MAIN](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[__GAMBIT_PLUGIN__](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type, plug_version)  |
|  | **[_GAMBIT_PLUGIN_](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type, plug_version)  |
|  | **[GAMBIT_PLUGIN_1](/documentation/code/files/plugin__macros_8hpp/)**(plugin_name)  |
|  | **[GAMBIT_PLUGIN_2](/documentation/code/files/plugin__macros_8hpp/)**(plugin_name, plug_type)  |
|  | **[GAMBIT_PLUGIN_3](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type, plug_version)  |
|  | **[GAMBIT_PLUGIN](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[___GAMBIT_PLUGIN_NAMESPACE___](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type, plug_version)  |
|  | **[_GAMBIT_PLUGIN_NAMESPACE_](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type, plug_version)  |
|  | **[__GAMBIT_PLUGIN_NAMESPACE___1](/documentation/code/files/plugin__macros_8hpp/)**(plug_name)  |
|  | **[__GAMBIT_PLUGIN_NAMESPACE___2](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type)  |
|  | **[__GAMBIT_PLUGIN_NAMESPACE___3](/documentation/code/files/plugin__macros_8hpp/)**(plug_name, plug_type, plug_version)  |
|  | **[__GAMBIT_PLUGIN_NAMESPACE__](/documentation/code/files/plugin__macros_8hpp/)**(...)  |
|  | **[GAMBIT_PLUGIN_INITIALIZE](/documentation/code/files/plugin__macros_8hpp/)**(setup, ...)  |
