...
|                | Name           |
| -------------- | -------------- |
|  | **[BE_FUNCTION_I_PY](/documentation/code/files/python__macros_8hpp/#define-python-macros-hpp-be-function-i-py)**(NAME, TYPE, ARGLIST, SYMBOLNAME, CAPABILITY, MODELS) <br>Backend function macro for Python backends.  |
|  | **[BE_VARIABLE_I_PY](/documentation/code/files/python__macros_8hpp/#define-python-macros-hpp-be-variable-i-py)**(NAME, TYPE, SYMBOLNAME, CAPABILITY, MODELS) <br>Backend variable macro for Python.  |
