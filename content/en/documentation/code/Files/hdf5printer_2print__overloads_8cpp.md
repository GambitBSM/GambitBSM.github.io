...
|                | Name           |
| -------------- | -------------- |
|  | **[PRINT](/documentation/code/files/hdf5printer_2print__overloads_8cpp/#define-hdf5printer-print-overloads-cpp-print)**(TYPE) <br>Templatable print functions.  |
|  | **[PRINTAS](/documentation/code/files/hdf5printer_2print__overloads_8cpp/#define-hdf5printer-print-overloads-cpp-printas)**(INTYPE, OUTTYPE)  |
