...
|                | Name           |
| -------------- | -------------- |
| void | **[usage](/documentation/code/files/manual__hdf5__combine_8cpp/#function-manual-hdf5-combine-cpp-usage)**() |
| int | **[main](/documentation/code/files/manual__hdf5__combine_8cpp/#function-manual-hdf5-combine-cpp-main)**(int argc, char * argv[]) |
...
This is code for a stand-alone binary which performs the end-of-run combination of temporary HDF5 files from a GAMBIT scan.

It is essentially the same code that GAMBIT runs automatically in the HDF5 printer, just moved into a stand-alone tool so that the combination can be done "manually" if needed.
