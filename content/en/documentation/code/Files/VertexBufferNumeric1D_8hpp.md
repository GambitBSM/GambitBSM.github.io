...
Declaration of VertexBufferNumeric1D class This version of VertexBufferBase adds a series of routines for managing a 1D data buffer (i.e. a 1D array of scalars), and for transmitting and receiving these buffers via MPI.
