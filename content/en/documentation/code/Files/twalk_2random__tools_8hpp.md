...
|                | Name           |
| -------------- | -------------- |
| template <typename T \> <br>T * | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN) |
| template <typename T \> <br>T ** | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, const int yN) |
| template <typename T \> <br>T *** | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, const int yN, const int zN) |
| template <typename T \> <br>T * | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, T in) |
| template <typename T \> <br>T ** | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, const int yN, T in) |
| template <typename T \> <br>T *** | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, const int yN, const int zN, T in) |
| template <typename T \> <br>T * | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, T * in) |
| template <typename T \> <br>T ** | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, const int yN, T ** in) |
| template <typename T \> <br>T *** | **[matrix](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-matrix)**(const int xN, const int yN, const int zN, T *** in) |
| template <typename T \> <br>void | **[del](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-del)**(T * temp) |
| template <typename T \> <br>void | **[del](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-del)**(T ** temp, int xN) |
| template <typename T \> <br>void | **[del](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-del)**(T *** temp, int xN, int yN) |
| template <class T \> <br>const T | **[SQ](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-sq)**(const T a) |
| template <class T \> <br>const T | **[SQR](/documentation/code/files/twalk_2random__tools_8hpp/#function-twalk-random-tools-hpp-sqr)**(const T a) |
