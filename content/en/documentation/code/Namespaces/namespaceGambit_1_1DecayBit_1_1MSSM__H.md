...
| double | **[gamma_h_chi_0](/documentation/code/namespaces/namespacegambit_1_1decaybit_1_1mssm__h/#function-gamma-h-chi)**(int i, int j, std::array< double, 4 > m, std::array< std::array< double, 4 >, 4 > Z, double alpha, double mh =125., double mw =80.385, double GF =1.1663787e-5, double sw2 =0.22) |
