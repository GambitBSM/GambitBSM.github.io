...
|                | Name           |
| -------------- | -------------- |
| def | **[getAbstractClassName](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(input_name input_name, prefix prefix =gb.abstr_class_prefix, short short =False) |
| def | **[constrEmptyTemplClassDecl](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(abstr_class_name_short abstr_class_name_short, namespaces namespaces, template_bracket template_bracket, indent indent =4) |
| def | **[constrTemplForwDecl](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_name_short class_name_short, namespaces namespaces, template_bracket template_bracket, indent indent =4) |
...
| def | **[getAcceptableConstructors](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_el class_el, skip_copy_constructors skip_copy_constructors =False) |
...
| def | **[constrWrapperFunction](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(method_el method_el, indent indent =cfg.indent, n_indents n_indents =0, remove_n_args remove_n_args =0, only_declaration only_declaration =False, include_full_namespace include_full_namespace =False) |
| def | **[constrVariableRefFunction](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(var_el var_el, virtual virtual =False, indent indent =cfg.indent, n_indents n_indents =0, only_declaration only_declaration =False, include_full_namespace include_full_namespace =False, add_return_type_suffix add_return_type_suffix =False) |
...
| def | **[checkAssignmentOperator](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_el class_el) |
| def | **[checkCopyConstructor](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_el class_el, return_id return_id =False) |
| def | **[toWrapperType](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(input_type_name input_type_name, remove_reference remove_reference =False, remove_pointers remove_pointers =False, include_namespace include_namespace =False, include_global_namespace include_global_namespace =False) |
| def | **[toAbstractType](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(input_type_name input_type_name, include_namespace include_namespace =True, add_pointer add_pointer =False, remove_reference remove_reference =False, remove_pointers remove_pointers =False) |
| def | **[getClassNameDict](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_el class_el, abstract abstract =False) |
...
| def | **[pureVirtualMembers](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_el class_el) |
...
| def | **[findClassNamePosition](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(class_el class_el, file_content_nocomments file_content_nocomments) |
| def | **[isAcceptedMemberVariable](/documentation/code/namespaces/namespacemodules_1_1classutils/)**(mem_el mem_el) |
