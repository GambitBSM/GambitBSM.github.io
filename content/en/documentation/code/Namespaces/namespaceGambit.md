...
| typedef [Farray](/documentation/code/classes/classgambit_1_1farray/)< Freal8, 1, 6, 1, 6 > | **[Farray_Freal8_1_6_1_6](/documentation/code/namespaces/namespacegambit/#typedef-farray-freal8-1-6-1-6)**  |
...
| typedef [Farray](/documentation/code/classes/classgambit_1_1farray/)< [Fstring](/documentation/code/classes/classgambit_1_1fstring/)< 60 >, 1, 15 > | **[Farray_Fstring60_1_15](/documentation/code/namespaces/namespacegambit/#typedef-farray-fstring60-1-15)**  |
...
| void | **[SLHAea_add_from_subspec](/documentation/code/namespaces/namespacegambit/#function-slhaea-add-from-subspec)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) local_info, const [SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/) & subspec, const [Par::Tags](/documentation/code/namespaces/namespacegambit_1_1par/#enum-tags) partype, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & name, const int index1, const int index2, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, const int slha_index1, const int slha_index2, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & comment, const bool error_if_missing =true, const double rescale =1.0)<br>Add an entry from a subspectrum getter to an SLHAea object; two [SubSpectrum]() getter indices, two SLHA indices.  |
| void | **[add_SimpleSpec_to_SLHAea](/documentation/code/namespaces/namespacegambit/#function-add-simplespec-to-slhaea)**(const [SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/) & subspec, [SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [SubSpectrumContents](/documentation/code/classes/classgambit_1_1subspectrumcontents/) & contents)<br>Write a SimpleSpectrum to an SLHAea object.  |
| int | **[SMlike_higgs_PDG_code](/documentation/code/namespaces/namespacegambit/#function-smlike-higgs-pdg-code)**(const [SubSpectrum](/documentation/code/classes/classgambit_1_1subspectrum/) & spec) |
| template <typename HE ,typename HEmod \> <br>[Spectrum](/documentation/code/classes/classgambit_1_1spectrum/) | **[spectrum_from_SLHAea](/documentation/code/namespaces/namespacegambit/#function-spectrum-from-slhaea)**(HEmod hemod, [SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) slhaea, const [Spectrum::mc_info](/documentation/code/classes/classgambit_1_1spectrum/#typedef-mc-info) & mci, const Spectrum::mr_info & mri)<br>Create a simple spectrum object from an SLHAea object.  |
| template <typename HE \> <br>[Spectrum](/documentation/code/classes/classgambit_1_1spectrum/) | **[spectrum_from_SLHA](/documentation/code/namespaces/namespacegambit/#function-spectrum-from-slha)**([str](/documentation/code/namespaces/namespacegambit/#typedef-str) slha, const [Spectrum::mc_info](/documentation/code/classes/classgambit_1_1spectrum/#typedef-mc-info) & mci, const Spectrum::mr_info & mri)<br>Create a simple spectrum object from an SLHA file.  |
| bool | **[within_bounds](/documentation/code/namespaces/namespacegambit/#function-within-bounds)**(const int i, const std::set< int > allowed)<br>Helper function for checking if indices are valid.  |
...
| std::string | **[format_for_screen](/documentation/code/namespaces/namespacegambit/#function-format-for-screen)**(const std::string & input_string) |
| void | **[print_to_screen](/documentation/code/namespaces/namespacegambit/#function-print-to-screen)**(const std::string & file_in, const std::string & name) |
| int | **[get_screen_cols](/documentation/code/namespaces/namespacegambit/#function-get-screen-cols)**() |
| std::string | **[separate_line](/documentation/code/namespaces/namespacegambit/#function-separate-line)**(std::string & line, std::string::size_type indent, std::string::size_type cols_pos) |
| std::string | **[signal_name](/documentation/code/namespaces/namespacegambit/#function-signal-name)**(int sig)<br>Translate signal codes to strings.  |
| EXPORT_SYMBOLS [SignalData](/documentation/code/classes/classgambit_1_1signaldata/) & | **[signaldata](/documentation/code/namespaces/namespacegambit/#function-signaldata)**()<br>Retrieve global instance of signal handler options struct.  |
| void | **[set_signal_handler](/documentation/code/namespaces/namespacegambit/#function-set-signal-handler)**(const YAML::Node & keyvalnode, const int sig, const std::string & def_mode)<br>Choose signal handler for a given signal via yaml file option.  |
| sigset_t * | **[signal_mask](/documentation/code/namespaces/namespacegambit/#function-signal-mask)**()<br>Getter for global signal set.  |
| [SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) | **[read_SLHA](/documentation/code/namespaces/namespacegambit/#function-read-slha)**([str](/documentation/code/namespaces/namespacegambit/#typedef-str) slha)<br>Read an SLHA file in to an SLHAea object with some error-checking.  |
| double | **[SLHAea_get](/documentation/code/namespaces/namespacegambit/#function-slhaea-get)**(const [SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, const int index)<br>Get an entry from an SLHAea object as a double, with some error checking.  |
...
| void | **[SLHAea_add_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-add-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & name, const double scale =-1)<br>Add a new block to an SLHAea object, with or without a scale.  |
| void | **[SLHAea_delete_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-delete-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const std::string & block)<br>Delete an entire block from an SLHAea object, if it exists (actually just the first block matching the given name)  |
| bool | **[SLHAea_block_exists](/documentation/code/namespaces/namespacegambit/#function-slhaea-block-exists)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block)<br>Check if a block exists in an SLHAea object.  |
| bool | **[SLHAea_check_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-check-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block)<br>Check if a block exists in an SLHAea object, add it if not.  |
| bool | **[SLHAea_check_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-check-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, const int index)<br>Check if a block exists in an SLHAea object, add it if not, and check if it has an entry at a given index.  |
| bool | **[SLHAea_check_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-check-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, const int index1, const int index2) |
| void | **[SLHAea_add_GAMBIT_SPINFO](/documentation/code/namespaces/namespacegambit/#function-slhaea-add-gambit-spinfo)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha)<br>Write the SPINFO block with GAMBIT name and version number.  |
| template <typename T \> <br>void | **[SLHAea_add_matrix](/documentation/code/namespaces/namespacegambit/#function-slhaea-add-matrix)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, const std::vector< T > & matrix, const int rows, const int cols, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & comment ="", const bool overwrite =false)<br>Add a whole matrix to an SLHAea object if it doesn't already exist.  |
| template <class T \> <br>void | **[SLHAea_overwrite_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-overwrite-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, int index, T value, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & comment)<br>Check if a line exists in an SLHAea block, then overwrite it if it does. Otherwise add the line.  |
| template <class T \> <br>void | **[SLHAea_overwrite_block](/documentation/code/namespaces/namespacegambit/#function-slhaea-overwrite-block)**([SLHAstruct](/documentation/code/namespaces/namespacegambit/#typedef-slhastruct) & slha, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & block, int index1, int index2, T value, const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & comment)<br>Check if a line exists in an SLHAea block, then overwrite it if it does. Otherwise add the line.  |
| EXPORT_SYMBOLS [error](/documentation/code/classes/classgambit_1_1error/) & | **[utils_error](/documentation/code/namespaces/namespacegambit/#function-utils-error)**()<br>Utility errors.  |
| EXPORT_SYMBOLS [warning](/documentation/code/classes/classgambit_1_1warning/) & | **[utils_warning](/documentation/code/namespaces/namespacegambit/#function-utils-warning)**()<br>Utility warnings.  |
| [error](/documentation/code/classes/classgambit_1_1error/) & | **[backend_error](/documentation/code/namespaces/namespacegambit/#function-backend-error)**()<br>Backend errors.  |
| [warning](/documentation/code/classes/classgambit_1_1warning/) & | **[backend_warning](/documentation/code/namespaces/namespacegambit/#function-backend-warning)**()<br>Backend warnings.  |
| [error](/documentation/code/classes/classgambit_1_1error/) & | **[logging_error](/documentation/code/namespaces/namespacegambit/#function-logging-error)**()<br>[Logging]() errors.  |
| [warning](/documentation/code/classes/classgambit_1_1warning/) & | **[logging_warning](/documentation/code/namespaces/namespacegambit/#function-logging-warning)**()<br>[Logging]() warnings.  |
| [error](/documentation/code/classes/classgambit_1_1error/) & | **[model_error](/documentation/code/namespaces/namespacegambit/#function-model-error)**()<br>Model errors.  |
...
| template <typename T ,typename U ,typename... Args\> <br>std::vector< T > | **[initVector](/documentation/code/namespaces/namespacegambit/#function-initvector)**(std::vector< T > vector, U value, Args... args) |
| template <typename T ,typename... Args\> <br>std::vector< T > | **[initVector](/documentation/code/namespaces/namespacegambit/#function-initvector)**(T value, Args... args) |
| template <typename T \> <br>std::set< T > | **[initSet](/documentation/code/namespaces/namespacegambit/#function-initset)**(std::set< T > set)<br>Same as above, but for sets.  |
| template <typename T ,typename... Args\> <br>std::set< T > | **[initSet](/documentation/code/namespaces/namespacegambit/#function-initset)**(std::set< T > set, T value, Args... args) |
| template <typename T ,typename U ,typename... Args\> <br>std::set< T > | **[initSet](/documentation/code/namespaces/namespacegambit/#function-initset)**(std::set< T > set, U value, Args... args) |
| template <typename T ,typename... Args\> <br>std::set< T > | **[initSet](/documentation/code/namespaces/namespacegambit/#function-initset)**(T value, Args... args) |
| const std::string | **[stringifyVariadic](/documentation/code/namespaces/namespacegambit/#function-stringifyvariadic)**() |
| const std::string | **[stringifyVariadic](/documentation/code/namespaces/namespacegambit/#function-stringifyvariadic)**(const std::string & str) |
| template <typename... args\> <br>const std::string | **[stringifyVariadic](/documentation/code/namespaces/namespacegambit/#function-stringifyvariadic)**(const std::string & str, const args &... strs) |
| [str](/documentation/code/namespaces/namespacegambit/#typedef-str) & | **[gambit_version](/documentation/code/namespaces/namespacegambit/#function-gambit-version)**()<br>Statically construct a string containing the full GAMBIT version information and return a reference to it.  |
| const YAML::Node | **[getVariadicNode](/documentation/code/namespaces/namespacegambit/#function-getvariadicnode)**(const YAML::Node & node) |
| const YAML::Node | **[getVariadicNode](/documentation/code/namespaces/namespacegambit/#function-getvariadicnode)**(const YAML::Node & node, std::string key) |
| template <typename... args\> <br>const YAML::Node | **[getVariadicNode](/documentation/code/namespaces/namespacegambit/#function-getvariadicnode)**(const YAML::Node & node, const std::string & key, const args &... keys) |
| [Piped_exceptions](/documentation/code/classes/classgambit_1_1piped__exceptions/) | **[piped_errors](/documentation/code/namespaces/namespacegambit/#function-piped-errors)**(1000 )<br>Global instance of [Piped_exceptions]() class for errors.  |
| [Piped_exceptions](/documentation/code/classes/classgambit_1_1piped__exceptions/) | **[piped_warnings](/documentation/code/namespaces/namespacegambit/#function-piped-warnings)**(1000 )<br>Global instance of [Piped_exceptions]() class for warnings.  |
| void | **[add_screen_spaces](/documentation/code/namespaces/namespacegambit/#function-add-screen-spaces)**(std::string & str, std::string::size_type size, std::string::size_type indent) |
| void | **[wrap_lines](/documentation/code/namespaces/namespacegambit/#function-wrap-lines)**(std::vector< std::vector< std::string > > & data_in, const std::vector< int > & widths, const std::vector< int > & minWidths, double pad, std::vector< unsigned char > * row_flags =0) |
| [str](/documentation/code/namespaces/namespacegambit/#typedef-str) | **[get_gambit_version](/documentation/code/namespaces/namespacegambit/#function-get-gambit-version)**()<br>Construct a string containing the full GAMBIT version information.  |
...
| const [SpecOverrideOptions](/documentation/code/classes/classgambit_1_1specoverrideoptions/)(1) | **[overrides_only](/documentation/code/namespaces/namespacegambit/#variable-overrides-only)**  |
| const [SpecOverrideOptions](/documentation/code/classes/classgambit_1_1specoverrideoptions/)(2) | **[ignore_overrides](/documentation/code/namespaces/namespacegambit/#variable-ignore-overrides)**  |
| const [Logging::endofmessage](/documentation/code/classes/structgambit_1_1logging_1_1endofmessage/) | **[EOM](/documentation/code/namespaces/namespacegambit/#variable-eom)** <br>Explicit const instance of the end of message struct in [Gambit](/documentation/code/namespaces/namespacegambit/) namespace.  |
| [Printers::PrinterManager](/documentation/code/classes/classgambit_1_1printers_1_1printermanager/) * | **[global_printer_manager](/documentation/code/namespaces/namespacegambit/#variable-global-printer-manager)**  |
| const std::vector< [str](/documentation/code/namespaces/namespacegambit/#typedef-str) > | **[gambit_citation_keys](/documentation/code/namespaces/namespacegambit/#variable-gambit-citation-keys)**  |
| [Piped_invalid_point](/documentation/code/classes/classgambit_1_1piped__invalid__point/) | **[piped_invalid_point](/documentation/code/namespaces/namespacegambit/#variable-piped-invalid-point)** <br>Global instance of piped invalid point class.  |
| [Piped_exceptions](/documentation/code/classes/classgambit_1_1piped__exceptions/) | **[piped_errors](/documentation/code/namespaces/namespacegambit/#variable-piped-errors)** <br>Global instance of [Piped_exceptions]() class for errors.  |
| [Piped_exceptions](/documentation/code/classes/classgambit_1_1piped__exceptions/) | **[piped_warnings](/documentation/code/namespaces/namespacegambit/#variable-piped-warnings)** <br>Global instance of [Piped_exceptions]() class for warnings.  |
| const double | **[pi](/documentation/code/namespaces/namespacegambit/#variable-pi)**  |
| const double | **[root2](/documentation/code/namespaces/namespacegambit/#variable-root2)**  |
| const double | **[zeta3](/documentation/code/namespaces/namespacegambit/#variable-zeta3)**  |
| const double | **[hbar](/documentation/code/namespaces/namespacegambit/#variable-hbar)**  |
| const double | **[K2eV](/documentation/code/namespaces/namespacegambit/#variable-k2ev)**  |
...
| const double | **[m_planck](/documentation/code/namespaces/namespacegambit/#variable-m-planck)**  |
| const double | **[m_planck_red](/documentation/code/namespaces/namespacegambit/#variable-m-planck-red)**  |
| const double | **[atomic_mass_unit](/documentation/code/namespaces/namespacegambit/#variable-atomic-mass-unit)**  |
| const double | **[m_proton_amu](/documentation/code/namespaces/namespacegambit/#variable-m-proton-amu)**  |
| const double | **[m_neutron_amu](/documentation/code/namespaces/namespacegambit/#variable-m-neutron-amu)**  |
| const double | **[m_proton](/documentation/code/namespaces/namespacegambit/#variable-m-proton)**  |
| const double | **[m_neutron](/documentation/code/namespaces/namespacegambit/#variable-m-neutron)**  |
...
| const double | **[GN_SI](/documentation/code/namespaces/namespacegambit/#variable-gn-si)**  |
| const double | **[kB_SI](/documentation/code/namespaces/namespacegambit/#variable-kb-si)**  |
| const double | **[kB_eV_over_K](/documentation/code/namespaces/namespacegambit/#variable-kb-ev-over-k)**  |
| const double | **[hP_SI](/documentation/code/namespaces/namespacegambit/#variable-hp-si)**  |
| const double | **[hP_eVs](/documentation/code/namespaces/namespacegambit/#variable-hp-evs)**  |
| const double | **[hc_eVcm](/documentation/code/namespaces/namespacegambit/#variable-hc-evcm)**  |
| const double | **[sigmaB_SI](/documentation/code/namespaces/namespacegambit/#variable-sigmab-si)**  |
| const double | **[Neff_SM](/documentation/code/namespaces/namespacegambit/#variable-neff-sm)**  |
| constexpr double | **[alpha_e_OS_thomson_limit](/documentation/code/namespaces/namespacegambit/#variable-alpha-e-os-thomson-limit)** <br>Thomson limit of \(\alpha_e\) in OS scheme from [PDG 2017](http://pdg.lbl.gov/2017/reviews/rpp2017-rev-phys-constants.pdf) |
| constexpr double | **[alpha_e_OS_MZ](/documentation/code/namespaces/namespacegambit/#variable-alpha-e-os-mz)** <br>\(\alpha_e(M_Z)\) in OS scheme from [1105.3149](https://arxiv.org/pdf/1105.3149.pdf) |
| constexpr double | **[delta_alpha_OS](/documentation/code/namespaces/namespacegambit/#variable-delta-alpha-os)** <br>\(\Delta\alpha\) in OS scheme.  |
| const struct Gambit::Mesons_masses | **[meson_masses](/documentation/code/namespaces/namespacegambit/#variable-meson-masses)**  |
| const struct Gambit::Mesons_decay_constants | **[meson_decay_constants](/documentation/code/namespaces/namespacegambit/#variable-meson-decay-constants)**  |
| const int | **[gambit_version_major](/documentation/code/namespaces/namespacegambit/#variable-gambit-version-major)**  |
| const int | **[gambit_version_minor](/documentation/code/namespaces/namespacegambit/#variable-gambit-version-minor)**  |
| const int | **[gambit_version_revision](/documentation/code/namespaces/namespacegambit/#variable-gambit-version-revision)**  |
| const [str](/documentation/code/namespaces/namespacegambit/#typedef-str) | **[gambit_version_patch](/documentation/code/namespaces/namespacegambit/#variable-gambit-version-patch)**  |
| const int | **[gambit_version_int](/documentation/code/namespaces/namespacegambit/#variable-gambit-version-int)**  |
